document.addEventListener("DOMContentLoaded", function () {
    ...
    orangeBtnColors.addEventListener('click', function () {
        ...
        const accordionButtonImg = document.querySelector('.calculator_container .accordion-container #heading12 .accordion-button img');

        // Add "display: flex" style to the accordion button image
        accordionButtonImg.style.display = 'flex';
    ...
    orangeBtnQuantity.addEventListener('click', function () {
        // Get the accordion button image element
        const accordionButtonImg = document.querySelector('.calculator_container .accordion-container #heading13 .accordion-button img');
