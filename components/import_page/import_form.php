<form class="import_form container">
    ...
    <input class="form-input" type="number" name="product-quantity" id="product-quantity" placeholder="Ilość">
    ...
    <div class="d-flex flex-row flex-wrap">
        <input class="form-input" type="number" name="product-price" id="product-price" placeholder="Cena">
    ...
    <div class="d-flex flex-row flex-wrap">
        ...
        <input class="form-input" type="number" name="telephone" id="telephone" placeholder="Telefon *" required>
