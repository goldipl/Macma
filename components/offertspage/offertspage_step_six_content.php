            ...
            <div class="offertspage-table_box d-flex flex-column">
                ...
                <div class="bottom-offertspage-box-with-btn">
                    ...
                    <div class="add-product-box">
                        ...
                        <button class="add-product">Przekształć w zamówienie <img src="./assets/icons/common/buttons/button_orange_arrow.svg" alt="arrow icon" width="18" height="18"></button>
                        <button class="add-product">Pobierz plik PDF <img src="./assets/icons/common/buttons/button_orange_arrow.svg" alt="arrow icon" width="18" height="18"></button>
                        <button class="add-product">Drukuj <img src="./assets/icons/common/buttons/button_orange_arrow.svg" alt="arrow icon" width="18" height="18"></button>
                        <button class="add-product">Wyślij <img src="./assets/icons/common/buttons/button_orange_arrow.svg" alt="arrow icon" width="18" height="18"></button>
                    </div>
